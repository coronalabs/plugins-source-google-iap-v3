...
public class IabHelper {
    ...
    public Inventory queryInventory(boolean querySkuDetails, Set<String> moreSkus) throws IabException {
     ...
     * Do not call from a UI thread. For that, use the non-blocking version {@code refreshInventoryAsync}.
     *
     ...
     */
    public Inventory queryInventory(boolean querySkuDetails, Set<String> moreItemSkus,
                                        Set<String> moreSubsSkus) throws IabException {
        checkNotDisposed();
     ...
     * @param moreSubSkus as in {@link #queryInventory}
     * @param listener The listener to notify when the refresh operation completes.
     */
    public void queryInventoryAsync(final boolean querySkuDetails,
                               final Set<String> moreSkus,
                               final Set<String> moreSubSkus,
    ...
    /**
     * Same as {@code consumeAsync}, but for multiple items at once.
    ...
    int querySkuDetails(String itemType, Inventory inv, Set<String> moreSkus)
        ...
        while(skuList.size() > 0) {
            ...
            packet.add(skuList.remove(0));
        }
        packets.add(packet);

        for (ArrayList<String> aSkuList : packets) {
            Bundle querySkus = new Bundle();
            querySkus.putStringArrayList(GET_SKU_DETAILS_ITEM_LIST, aSkuList);
